...
var require_face_detection = __commonJS({
  "node_modules/@mediapipe/face_detection/face_detection.js"(exports) {
    (function() {
      ...
      B("Promise", function(a) {
        ...
        b.all = function(f) {
          ...
          return k.done ? d([]) : new b(function(l, m) {
            ...
            var p = [], n = 0;
            do
              p.push(void 0), n++, d(k.value).M(q(p.length - 1), m), k = h.next();
            while (!k.done);
          });
        };
        return b;
      ...
      function Ya(a, b) {
        Object.isFrozen(a) || (U ? a[U] |= b : void 0 !== a.N ? a.N |= b : Object.defineProperties(a, { N: { value: b, configurable: true, writable: true, enumerable: false } }));
      }
      function Za(a) {
        var b;
        U ? b = a[U] : b = a.N;
      ...
      function sb(a, b, c) {
        ...
        if (c)
          for (b = 0; b < c.length; b++)
            if (a = c[b], a < this.i)
              a += this.h, (d = this.m[a]) ? Array.isArray(d) && $a(d) : this.m[a] = db;
            else {
      ...
      function Ub(a, b, c) {
        ...
        try {
          ...
          b = a.g, b.h = null, b.j = 0, b.i = 0, b.g = 0, b.v = false, a.i = -1, a.h = -1, 100 > Va.length && Va.push(a);
        }
      }
      function Jb(a, b, c) {
      ...
      var Y = Wb(function(a, b, c) {
        ...
        if (null != b) {
          ...
          var d = b;
          d = (c = 0 > d ? 1 : 0) ? -d : d;
          0 === d ? 0 < 1 / d ? N = O = 0 : (O = 0, N = 2147483648) : isNaN(d) ? (O = 0, N = 2147483647) : 34028234663852886e22 < d ? (O = 0, N = (c << 31 | 2139095040) >>> 0) : 11754943508222875e-54 > d ? (d = Math.round(d / Math.pow(2, -149)), O = 0, N = (c << 31 | d) >>> 0) : (b = Math.floor(Math.log(d) / Math.LN2), d *= Math.pow(2, -b), d = Math.round(8388608 * d), 16777216 <= d && ++b, O = 0, N = (c << 31 | b + 127 << 23 | d & 8388607) >>> 0);
          c = N;
          a.g.push(c >>> 0 & 255);
          a.g.push(c >>> 8 & 255);
          a.g.push(c >>> 16 & 255);
        ...
        var g;
        if (ya)
          (g = xa) || (g = xa = new TextDecoder("utf-8", { fatal: true })), g = g.decode(a.subarray(e, e + d));
        else {
          d = e + d;
          for (var f = [], h = null, k, l, m; e < d; )
            k = a[e++], 128 > k ? f.push(k) : 224 > k ? e >= d ? L() : (l = a[e++], 194 > k || 128 !== (l & 192) ? (e--, L()) : f.push((k & 31) << 6 | l & 63)) : 240 > k ? e >= d - 1 ? L() : (l = a[e++], 128 !== (l & 192) || 224 === k && 160 > l || 237 === k && 160 <= l || 128 !== ((g = a[e++]) & 192) ? (e--, L()) : f.push((k & 15) << 12 | (l & 63) << 6 | g & 63)) : 244 >= k ? e >= d - 2 ? L() : (l = a[e++], 128 !== (l & 192) || 0 !== (k << 28) + (l - 144) >> 30 || 128 !== ((g = a[e++]) & 192) || 128 !== ((m = a[e++]) & 192) ? (e--, L()) : (k = (k & 7) << 18 | (l & 63) << 12 | (g & 63) << 6 | m & 63, k -= 65536, f.push((k >> 10 & 1023) + 55296, (k & 1023) + 56320))) : L(), 8192 <= f.length && (h = wa(h, f), f.length = 0);
          g = wa(h, f);
        }
        W(b, c, g);
        return true;
      ...
      function vc(a) {
        return ib(a, bc, 1).map(function(b) {
          return { index: kb(b, 1), ga: X(b, 2), label: null != V(b, 3) ? lb(b, 3) : void 0, displayName: null != V(b, 4) ? lb(b, 4) : void 0 };
        });
      }
      ;
      function wc(a) {
      ...
      function zc(a, b) {
        ...
        if (void 0 === a.o) {
          ...
          a.j = { K: c.getAttribLocation(d, "aVertex"), J: c.getAttribLocation(d, "aTex"), ma: e };
          a.u = c.createBuffer();
        ...
        return J(function(p) {
          switch (p.g) {
            ...
            case 2:
              c = p.h;
              if ("object" === typeof window)
                return Dc("createMediapipeSolutionsWasm", { locateFile: a.locateFile }), Dc("createMediapipeSolutionsPackedAssets", { locateFile: a.locateFile }), f = b.filter(function(n) {
                  ...
                  return J(function(w) {
                    if (1 == w.g)
                      return n = window.createMediapipeSolutionsWasm, r = window.createMediapipeSolutionsPackedAssets, t = a, G(w, n(r), 2);
                    t.h = w.h;
                    w.g = 0;
                  });
                }), m = function() {
                  return J(function(n) {
                    a.g.graph && a.g.graph.url ? n = G(
                      n,
                      Ic(a, a.g.graph.url),
                      0
                    ) : (n.g = 0, n = void 0);
                    ...
                    switch (k.type) {
                      ...
                      case "detections":
                        ...
                        for (w = 0; w < n.length; ++w) {
                          ...
                          A.call(v, I, F);
                          if (t.landmarks)
                            for (v = 0; v < t.landmarks.length; ++v) {
                              u = t.landmarks[v];
                          ...
                          if (t.V)
                            for (v = 0; v < t.V.length; ++v)
                              A = r.data, I = A.addClassification, F = w, u = t.V[v], z = new bc(), W(z, 2, u.ga), u.index && W(z, 1, u.index), u.label && W(z, 3, u.label), u.displayName && W(z, 4, u.displayName), u = Vb(z, cc), I.call(A, F, u);
                        }
                        r = r.data;
                        break a;
                      default:
        ...
        return J(function(v) {
          switch (v.g) {
            ...
            case 2:
              ...
              if ("detection_list" === q.type) {
                if (p) {
                  ...
                  for (var I = p.getLandmarksList(), F = p.getClassificationsList(), u = [], z = 0; z < A.size(); ++z) {
                    ...
                    R = { boundingBox: { xCenter: X(R, 1), yCenter: X(R, 2), height: X(R, 3), width: X(R, 4), rotation: X(R, 5, 0), rectId: kb(R, 6) }, landmarks: ib(Ub(I.get(z), ic, kc), gc, 1).map(wc), V: vc(Ub(F.get(z), dc, fc)) };
                    u.push(R);
                  }
                  A = u;
                } else
              ...
              if ("texture" !== q.type)
                throw Error("Unknown output config type: '" + q.type + "'");
              n = a.u[m];
      ...
      function Kc(a, b) {
        for (var c = b.name || "$", d = [].concat(D(b.wants)), e = new a.h.StringList(), g = C(b.wants), f = g.next(); !f.done; f = g.next())
          e.push_back(f.value);
      ...
      K("Solution", Gc);
      K("OptionType", { BOOL: 0, NUMBER: 1, ia: 2, 0: "BOOL", 1: "NUMBER", 2: "STRING" });
      function Oc(a) {
        var b = this;
        a = a || {};
            ...
            return J(function(q) {
              switch (q.g) {
                ...
                case 5:
                  ...
                  break;
                case 4:
                  return c.url = "short" === e ? "face_detection_short.binarypb" : "face_detection_full.binarypb", d.graphOptionXref.calculatorName = "short" === e ? "facedetectionshortrangegpu__facedetectionshortrangecommon__TensorsToDetectionsCalculator" : "facedetectionfullrangegpu__facedetectionfullrangecommon__TensorsToDetectionsCalculator", q.return(true);
              }
            });
...
export default require_face_detection();
//# sourceMappingURL=@mediapipe_face_detection.js.map
