...
# Use dict-unpacking to bypass false-positive lint warnings in IDEs
...
async def submit_exam(request: dict):
    ...
    if is_flagged:
        message: str = "Exam FLAGGED due to proctoring violations. Score forced to 0."
        score = 0
    else:
        ...
        for q in QUESTIONS:
            ...
            is_correct: bool = user_choice == q.correct_option
            if is_correct:
                score = score + 1
